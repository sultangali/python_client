        ...
        <Container fluid style={{ backgroundColor: '#f9f9f9', height: '100vh' }}>
            <Container>
                <div className="text-center ">
                    <br />
                    <h3 className="text-primary heading-margin">Студенттерді оқыту жүйесіне қол жеткізу</h3>
                ...
                <Row className='d-flex justify-content-center'>
                    <Card className='shadow-lg p-4 mb-5 bg-white rounded static-card profile-access-denied-card' style={{ width: '600px' }}>
                        <Card.Body className='text-center'>
                            ...
                            <Button className="btn btn-primary signup shadow mx-2" style={{borderRadius: '4px'}} href='/for-student/login'>Кіру</Button>
                            <Button className="btn btn-secondary signup shadow mx-2" style={{borderRadius: '4px'}}  href='/for-student/registration'>Тіркелу</Button>
                        </Card.Body>
                    </Card>
                </Row>
            </Container>
